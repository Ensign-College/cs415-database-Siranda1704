...
(user_phone_id,web_user_id,phone_number,phone_type_id,created_date)
VALUES
(1,1,'801-555-1111',1,CURRENT_TIMESTAMP),
(2,1,'801-555-2222',2,CURRENT_TIMESTAMP),
(3,2,'801-555-3333',1,CURRENT_TIMESTAMP),
(4,2,'801-555-4444',3,CURRENT_TIMESTAMP);

ALTER SEQUENCE UserPhone_user_phone_id_seq RESTART WITH 5;

-- UserInfo
INSERT INTO UserInfo
(user_info_id,web_user_id,profile_bio,profile_picture,created_date,updated_date)
VALUES
(
1,
1,
'Main user profile bio',
...
(page_data_id,week_name,topic,description,image_url,page_title)
VALUES
...
(2,'Week 2','Database Container and API','Install PostgreSQL in a container and access the data. Install and setup Django Rest Framework for API - create GET endpoints','https://miro.medium.com/v2/resize:fit:720/format:webp/0*prut14lFoArZnPK5.jpg','Week 2 - Postgres DB, Django API'),
...
(5,'Week 5','AWS Elastic Container Service','Discuss ECR, ECS and Fargate. Deploy the Docker API image to AWS and run it through a Network Load Balancer. Assignment - validate API is running in Fargate','https://miro.medium.com/v2/resize:fit:720/format:webp/1*bEOOOxnCV2nXpGvXkOErRg.png','Week 5 - AWS ECS'),
